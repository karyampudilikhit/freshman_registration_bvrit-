...
// FIX: removed local ADMIN_DEMO_MODE — now uses shared DEMO_MODE from config
...
const adminService = {
  ...
  exportStudentData: async (filters = {}) => {
    if (DEMO_MODE) return { downloadUrl: '' };
