...
const styles = StyleSheet.create({
  ...
  // ✅ FIXED: replaced aspectRatio:1 with fixed height: 36 to prevent giant cells
  dayCell: { width: '14.28%', height: 36, justifyContent: 'center', alignItems: 'center', borderRadius: 18 },
